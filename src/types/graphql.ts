...
export type GetCollectionQuery = { collection?: { title: string, products: { nodes: Array<{ id: string, title: string, description: string, images: { edges: Array<{ node: { altText?: string | null, height?: number | null, width?: number | null, id?: string | null, url: any } }> } }> } } | null };
...
export type GetProductsQuery = { products: { pageInfo: { hasNextPage: boolean }, edges: Array<{ node: { id: string, title: string, description: string, images: { edges: Array<{ node: { altText?: string | null, height?: number | null, width?: number | null, id?: string | null, url: any } }> } } }> } };

...
export type CoreProductFragment = { id: string, title: string, description: string, tags: Array<string>, variants: { nodes: Array<{ priceV2: { amount: any, currencyCode: CurrencyCode } }> }, images: { edges: Array<{ node: { altText?: string | null, height?: number | null, width?: number | null, id?: string | null, url: any } }> } };
...
export type GetProductQuery = { product?: { id: string, title: string, description: string, tags: Array<string>, variants: { nodes: Array<{ priceV2: { amount: any, currencyCode: CurrencyCode } }> }, images: { edges: Array<{ node: { altText?: string | null, height?: number | null, width?: number | null, id?: string | null, url: any } }> } } | null };

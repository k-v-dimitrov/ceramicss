...
export type GetProductsQuery = { products: { edges: Array<{ node: { id: string, title: string, description: string, images: { edges: Array<{ node: { altText?: string | null, height?: number | null, width?: number | null, id?: string | null, url: any } }> } } }> } };

...
export type GetCartQuery = { cart?: { id: string, checkoutUrl: any, lines: { nodes: Array<{ id: string, quantity: number, merchandise: { priceV2: { amount: any, currencyCode: CurrencyCode }, product: { tags: Array<string>, title: string, description: string, images: { nodes: Array<{ url: any }> } } } }> } } | null };

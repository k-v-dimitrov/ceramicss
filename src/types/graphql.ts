...
export type GetProductsIdsQuery = { products: { edges: Array<{ node: { id: string } }> } };

export type GetProductsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductsQuery = { products: { pageInfo: { hasNextPage: boolean }, edges: Array<{ node: { id: string, title: string, description: string, tags: Array<string>, variants: { nodes: Array<{ id: string, priceV2: { amount: any, currencyCode: CurrencyCode } }> }, images: { edges: Array<{ node: { altText?: string | null, height?: number | null, width?: number | null, id?: string | null, url: any } }> } } }> } };

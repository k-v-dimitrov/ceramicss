...
export type CoreProductFragment = { id: string, title: string, description: string, variants: { nodes: Array<{ priceV2: { amount: any, currencyCode: CurrencyCode } }> }, images: { edges: Array<{ node: { altText?: string | null, height?: number | null, width?: number | null, id?: string | null, url: any } }> } };
...
export type GetCollectionProductsQuery = { collection?: { products: { edges: Array<{ node: { id: string, title: string, description: string, variants: { nodes: Array<{ priceV2: { amount: any, currencyCode: CurrencyCode } }> }, images: { edges: Array<{ node: { altText?: string | null, height?: number | null, width?: number | null, id?: string | null, url: any } }> } } }> } } | null };
...
export type GetCollectionQuery = { collection?: { title: string, products: { nodes: Array<{ id: string, title: string, description: string, variants: { nodes: Array<{ priceV2: { amount: any, currencyCode: CurrencyCode } }> }, images: { edges: Array<{ node: { altText?: string | null, height?: number | null, width?: number | null, id?: string | null, url: any } }> } }> } } | null };
...
export type GetProductQuery = { product?: { id: string, title: string, description: string, variants: { nodes: Array<{ priceV2: { amount: any, currencyCode: CurrencyCode } }> }, images: { edges: Array<{ node: { altText?: string | null, height?: number | null, width?: number | null, id?: string | null, url: any } }> } } | null };
...
export type GetProductsQuery = { products: { pageInfo: { hasNextPage: boolean }, edges: Array<{ node: { id: string, title: string, description: string, variants: { nodes: Array<{ priceV2: { amount: any, currencyCode: CurrencyCode } }> }, images: { edges: Array<{ node: { altText?: string | null, height?: number | null, width?: number | null, id?: string | null, url: any } }> } } }> } };

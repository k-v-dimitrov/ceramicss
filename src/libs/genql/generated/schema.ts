...
export type BaseCartLine = (CartLine) & { __isUnion?: true }
...
export interface CartCompletionActionRequired {
    ...
    action: (CartCompletionAction | null)
...
export type CartErrorCode = 'INVALID' | 'LESS_THAN' | 'INVALID_MERCHANDISE_LINE' | 'MISSING_DISCOUNT_CODE' | 'MISSING_NOTE' | 'INVALID_DELIVERY_GROUP' | 'INVALID_DELIVERY_OPTION' | 'INVALID_PAYMENT' | 'PAYMENT_METHOD_NOT_SUPPORTED' | 'INVALID_PAYMENT_EMPTY_CART' | 'INVALID_METAFIELDS'
...
export interface CartSubmitForCompletionPayload {
    ...
    result: (CartSubmitForCompletionResult | null)
    /** The list of errors that occurred from executing the mutation. */
    userErrors: CartUserError[]
...
export interface MetafieldDeleteUserError {
    /** The error code. */
    code: (MetafieldDeleteErrorCode | null)
    /** The path to the input field that caused the error. */
    field: (Scalars['String'][] | null)
    /** The error message. */
    message: Scalars['String']
...
export interface MetafieldsSetUserError {
    /** The error code. */
    code: (MetafieldsSetUserErrorCode | null)
    /** The index of the array element that's causing the error. */
    elementIndex: (Scalars['Int'] | null)
    /** The path to the input field that caused the error. */
    field: (Scalars['String'][] | null)
    /** The error message. */
    message: Scalars['String']
...
export interface Mutation {
    ...
    cartMetafieldDelete: (CartMetafieldDeletePayload | null)
    /**
...
export interface QueryRoot {
    ...
    cartCompletionAttempt: (CartCompletionAttemptResult | null)
...
/** Represents a cart line common fields. */
export interface BaseCartLineGenqlSelection{
    /** An attribute associated with the cart line. */
 ...
 * 
 */
export interface BaseCartLineConnectionGenqlSelection{
    /** A list of edges. */
    edges?: BaseCartLineEdgeGenqlSelection
    /** A list of the nodes contained in BaseCartLineEdge. */
    nodes?: BaseCartLineGenqlSelection
    /** Information to aid in pagination. */
    pageInfo?: PageInfoGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
 ...
 * 
 */
export interface BaseCartLineEdgeGenqlSelection{
    /** A cursor for use in pagination. */
    cursor?: boolean | number
    /** The item at the end of BaseCartLineEdge. */
    node?: BaseCartLineGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface CartGenqlSelection{
    ...
    id?: boolean | number
    /** A list of lines containing information about the items the customer intends to purchase. */
    lines?: (BaseCartLineConnectionGenqlSelection & { __args?: {
    /** Returns up to the first `n` elements from the list. */
    first?: (Scalars['Int'] | null), 
    /** Returns the elements that come after the specified cursor. */
    after?: (Scalars['String'] | null), 
...
/** The completion action to checkout a cart. */
export interface CartCompletionActionGenqlSelection{
    on_CompletePaymentChallenge?:CompletePaymentChallengeGenqlSelection,
    __typename?: boolean | number
}


/** The required completion action to checkout a cart. */
export interface CartCompletionActionRequiredGenqlSelection{
    /** The action required to complete the cart completion attempt. */
    action?: CartCompletionActionGenqlSelection
    /** The ID of the cart completion attempt. */
    id?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The result of a cart completion attempt. */
export interface CartCompletionAttemptResultGenqlSelection{
    on_CartCompletionActionRequired?:CartCompletionActionRequiredGenqlSelection,
    on_CartCompletionFailed?:CartCompletionFailedGenqlSelection,
    on_CartCompletionProcessing?:CartCompletionProcessingGenqlSelection,
    on_CartCompletionSuccess?:CartCompletionSuccessGenqlSelection,
    __typename?: boolean | number
}


/** A failed completion to checkout a cart. */
export interface CartCompletionFailedGenqlSelection{
    /** The errors that caused the checkout to fail. */
    errors?: CompletionErrorGenqlSelection
    /** The ID of the cart completion attempt. */
    id?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** A cart checkout completion that's still processing. */
export interface CartCompletionProcessingGenqlSelection{
    /** The ID of the cart completion attempt. */
    id?: boolean | number
    /** The number of milliseconds to wait before polling again. */
...
/** A successful completion to checkout a cart and a created order. */
export interface CartCompletionSuccessGenqlSelection{
    /** The date and time when the job completed. */
...
export interface CartDeliveryGroupGenqlSelection{
    /** A list of cart lines for the delivery group. */
    cartLines?: (BaseCartLineConnectionGenqlSelection & { __args?: {
    /** Returns up to the first `n` elements from the list. */
    first?: (Scalars['Int'] | null), 
    /** Returns the elements that come after the specified cursor. */
    after?: (Scalars['String'] | null), 
...
/** Return type for `cartMetafieldDelete` mutation. */
export interface CartMetafieldDeletePayloadGenqlSelection{
    /** The ID of the deleted cart metafield. */
    deletedId?: boolean | number
    /** The list of errors that occurred from executing the mutation. */
    userErrors?: MetafieldDeleteUserErrorGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** Return type for `cartMetafieldsSet` mutation. */
export interface CartMetafieldsSetPayloadGenqlSelection{
    /** The list of cart metafields that were set. */
...
/** Return type for `cartPaymentUpdate` mutation. */
export interface CartPaymentUpdatePayloadGenqlSelection{
    /** The updated cart. */
    cart?: CartGenqlSelection
    /** The list of errors that occurred from executing the mutation. */
    userErrors?: CartUserErrorGenqlSelection
...
/** Return type for `cartSubmitForCompletion` mutation. */
export interface CartSubmitForCompletionPayloadGenqlSelection{
    /** The result of cart submission for completion. */
    result?: CartSubmitForCompletionResultGenqlSelection
    /** The list of errors that occurred from executing the mutation. */
    userErrors?: CartUserErrorGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The result of cart submit completion. */
export interface CartSubmitForCompletionResultGenqlSelection{
    on_SubmitAlreadyAccepted?:SubmitAlreadyAcceptedGenqlSelection,
    on_SubmitFailed?:SubmitFailedGenqlSelection,
    on_SubmitSuccess?:SubmitSuccessGenqlSelection,
    on_SubmitThrottled?:SubmitThrottledGenqlSelection,
    __typename?: boolean | number
}
...
/** The action for the 3DS payment redirect. */
export interface CompletePaymentChallengeGenqlSelection{
    /** The URL for the 3DS payment redirect. */
...
/** An error that occurred during a cart completion attempt. */
export interface CompletionErrorGenqlSelection{
    /** The error code. */
    code?: boolean | number
    /** The error message. */
    message?: boolean | number
...
export interface DisplayableErrorGenqlSelection{
    ...
    on_MetafieldDeleteUserError?: MetafieldDeleteUserErrorGenqlSelection
...
export interface ExternalVideoGenqlSelection{
    ...
    /** The presentation for a media. */
    presentation?: MediaPresentationGenqlSelection
    /** The preview image for the media. */
...
/** A media presentation. */
export interface MediaPresentationGenqlSelection{
    /** A JSON object representing a presentation view. */
    asJson?: { __args: {
...
/** An error that occurs during the execution of cart metafield deletion. */
export interface MetafieldDeleteUserErrorGenqlSelection{
    /** The error code. */
    code?: boolean | number
    /** The path to the input field that caused the error. */
    field?: boolean | number
...
export interface MutationGenqlSelection{
    ...
    /** Deletes a cart metafield. */
    cartMetafieldDelete?: (CartMetafieldDeletePayloadGenqlSelection & { __args: {
     ...
     * 
     */
    cartMetafieldsSet?: (CartMetafieldsSetPayloadGenqlSelection & { __args: {
    ...
    note?: (Scalars['String'] | null)} })
    /** Update the customer's payment method that will be used to checkout. */
    cartPaymentUpdate?: (CartPaymentUpdatePayloadGenqlSelection & { __args: {
    /** The ID of the cart. */
    cartId: Scalars['ID'], 
    ...
    /** Submit the cart for checkout completion. */
    cartSubmitForCompletion?: (CartSubmitForCompletionPayloadGenqlSelection & { __args: {
    /** The ID of the cart. */
    cartId: Scalars['ID'], 
    /**
...
export interface NodeGenqlSelection{
    ...
    on_Market?: MarketGenqlSelection
    on_MediaImage?: MediaImageGenqlSelection
    on_MediaPresentation?: MediaPresentationGenqlSelection
...
export interface QueryRootGenqlSelection{
    ...
    id: Scalars['ID']} })
    /** A poll for the status of the cart checkout completion and order creation. */
    cartCompletionAttempt?: (CartCompletionAttemptResultGenqlSelection & { __args: {
...
/** An error that occurred during cart submit for completion. */
export interface SubmissionErrorGenqlSelection{
    /** The error code. */
    code?: boolean | number
    /** The error message. */
    message?: boolean | number
...
/** Cart submit for checkout completion is successful. */
export interface SubmitAlreadyAcceptedGenqlSelection{
    /** The ID of the cart completion attempt that will be used for polling for the result. */
...
/** Cart submit for checkout completion failed. */
export interface SubmitFailedGenqlSelection{
    /** The URL of the checkout for the cart. */
    checkoutUrl?: boolean | number
    /** The list of errors that occurred from executing the mutation. */
    errors?: SubmissionErrorGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** Cart submit for checkout completion is already accepted. */
export interface SubmitSuccessGenqlSelection{
    /** The ID of the cart completion attempt that will be used for polling for the result. */
    attemptId?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** Cart submit for checkout completion is throttled. */
export interface SubmitThrottledGenqlSelection{
    /**
     * UTC date time string that indicates the time after which clients should make their next
     * poll request. Any poll requests sent before this time will be ignored. Use this value to schedule the
     * next poll request.
...
export type QueryGenqlSelection = QueryRootGenqlSelection
    ...
    const BaseCartLine_possibleTypes: string[] = ['CartLine']
...
export const enumCartCardSource = {
   SAVED_CREDIT_CARD: 'SAVED_CREDIT_CARD' as const
}
...
export const enumCartErrorCode = {
   ...
   INVALID_DELIVERY_GROUP: 'INVALID_DELIVERY_GROUP' as const,
   INVALID_DELIVERY_OPTION: 'INVALID_DELIVERY_OPTION' as const,
   INVALID_PAYMENT: 'INVALID_PAYMENT' as const,
   PAYMENT_METHOD_NOT_SUPPORTED: 'PAYMENT_METHOD_NOT_SUPPORTED' as const,
   INVALID_PAYMENT_EMPTY_CART: 'INVALID_PAYMENT_EMPTY_CART' as const,
...
export const enumCheckoutErrorCode = {
   ...
   PRODUCT_NOT_AVAILABLE: 'PRODUCT_NOT_AVAILABLE' as const
}
...
export const enumCompletionErrorCode = {
   ERROR: 'ERROR' as const,
   INVENTORY_RESERVATION_ERROR: 'INVENTORY_RESERVATION_ERROR' as const,
   PAYMENT_ERROR: 'PAYMENT_ERROR' as const,
   PAYMENT_TRANSIENT_ERROR: 'PAYMENT_TRANSIENT_ERROR' as const,
   PAYMENT_AMOUNT_TOO_SMALL: 'PAYMENT_AMOUNT_TOO_SMALL' as const,
   PAYMENT_GATEWAY_NOT_ENABLED_ERROR: 'PAYMENT_GATEWAY_NOT_ENABLED_ERROR' as const,
   PAYMENT_INSUFFICIENT_FUNDS: 'PAYMENT_INSUFFICIENT_FUNDS' as const,
   PAYMENT_INVALID_PAYMENT_METHOD: 'PAYMENT_INVALID_PAYMENT_METHOD' as const,
   PAYMENT_INVALID_CURRENCY: 'PAYMENT_INVALID_CURRENCY' as const,
   PAYMENT_INVALID_CREDIT_CARD: 'PAYMENT_INVALID_CREDIT_CARD' as const,
   PAYMENT_INVALID_BILLING_ADDRESS: 'PAYMENT_INVALID_BILLING_ADDRESS' as const,
   PAYMENT_CARD_DECLINED: 'PAYMENT_CARD_DECLINED' as const,
   PAYMENT_CALL_ISSUER: 'PAYMENT_CALL_ISSUER' as const
}
...
export const enumMediaPresentationFormat = {
   MODEL_VIEWER: 'MODEL_VIEWER' as const,
   IMAGE: 'IMAGE' as const
}
...
export const enumMetafieldDeleteErrorCode = {
   INVALID_OWNER: 'INVALID_OWNER' as const,
   METAFIELD_DOES_NOT_EXIST: 'METAFIELD_DOES_NOT_EXIST' as const
}
...
export const enumProductRecommendationIntent = {
...
export const enumSubmissionErrorCode = {
   ERROR: 'ERROR' as const,
   NO_DELIVERY_GROUP_SELECTED: 'NO_DELIVERY_GROUP_SELECTED' as const,
   BUYER_IDENTITY_EMAIL_IS_INVALID: 'BUYER_IDENTITY_EMAIL_IS_INVALID' as const,
   BUYER_IDENTITY_EMAIL_REQUIRED: 'BUYER_IDENTITY_EMAIL_REQUIRED' as const,
   BUYER_IDENTITY_PHONE_IS_INVALID: 'BUYER_IDENTITY_PHONE_IS_INVALID' as const,
   DELIVERY_ADDRESS1_INVALID: 'DELIVERY_ADDRESS1_INVALID' as const,
   DELIVERY_ADDRESS1_REQUIRED: 'DELIVERY_ADDRESS1_REQUIRED' as const,
   DELIVERY_ADDRESS1_TOO_LONG: 'DELIVERY_ADDRESS1_TOO_LONG' as const,
   DELIVERY_ADDRESS2_INVALID: 'DELIVERY_ADDRESS2_INVALID' as const,
   DELIVERY_ADDRESS2_REQUIRED: 'DELIVERY_ADDRESS2_REQUIRED' as const,
   DELIVERY_ADDRESS2_TOO_LONG: 'DELIVERY_ADDRESS2_TOO_LONG' as const,
   DELIVERY_CITY_INVALID: 'DELIVERY_CITY_INVALID' as const,
   DELIVERY_CITY_REQUIRED: 'DELIVERY_CITY_REQUIRED' as const,
   DELIVERY_CITY_TOO_LONG: 'DELIVERY_CITY_TOO_LONG' as const,
   DELIVERY_COMPANY_INVALID: 'DELIVERY_COMPANY_INVALID' as const,
   DELIVERY_COMPANY_REQUIRED: 'DELIVERY_COMPANY_REQUIRED' as const,
   DELIVERY_COMPANY_TOO_LONG: 'DELIVERY_COMPANY_TOO_LONG' as const,
   DELIVERY_COUNTRY_REQUIRED: 'DELIVERY_COUNTRY_REQUIRED' as const,
   DELIVERY_FIRST_NAME_INVALID: 'DELIVERY_FIRST_NAME_INVALID' as const,
   DELIVERY_FIRST_NAME_REQUIRED: 'DELIVERY_FIRST_NAME_REQUIRED' as const,
   DELIVERY_FIRST_NAME_TOO_LONG: 'DELIVERY_FIRST_NAME_TOO_LONG' as const,
   DELIVERY_INVALID_POSTAL_CODE_FOR_COUNTRY: 'DELIVERY_INVALID_POSTAL_CODE_FOR_COUNTRY' as const,
   DELIVERY_INVALID_POSTAL_CODE_FOR_ZONE: 'DELIVERY_INVALID_POSTAL_CODE_FOR_ZONE' as const,
   DELIVERY_LAST_NAME_INVALID: 'DELIVERY_LAST_NAME_INVALID' as const,
   DELIVERY_LAST_NAME_REQUIRED: 'DELIVERY_LAST_NAME_REQUIRED' as const,
   DELIVERY_LAST_NAME_TOO_LONG: 'DELIVERY_LAST_NAME_TOO_LONG' as const,
   DELIVERY_NO_DELIVERY_AVAILABLE: 'DELIVERY_NO_DELIVERY_AVAILABLE' as const,
   DELIVERY_NO_DELIVERY_AVAILABLE_FOR_MERCHANDISE_LINE: 'DELIVERY_NO_DELIVERY_AVAILABLE_FOR_MERCHANDISE_LINE' as const,
   DELIVERY_OPTIONS_PHONE_NUMBER_INVALID: 'DELIVERY_OPTIONS_PHONE_NUMBER_INVALID' as const,
   DELIVERY_OPTIONS_PHONE_NUMBER_REQUIRED: 'DELIVERY_OPTIONS_PHONE_NUMBER_REQUIRED' as const,
   DELIVERY_PHONE_NUMBER_INVALID: 'DELIVERY_PHONE_NUMBER_INVALID' as const,
   DELIVERY_PHONE_NUMBER_REQUIRED: 'DELIVERY_PHONE_NUMBER_REQUIRED' as const,
   DELIVERY_POSTAL_CODE_INVALID: 'DELIVERY_POSTAL_CODE_INVALID' as const,
   DELIVERY_POSTAL_CODE_REQUIRED: 'DELIVERY_POSTAL_CODE_REQUIRED' as const,
   DELIVERY_ZONE_NOT_FOUND: 'DELIVERY_ZONE_NOT_FOUND' as const,
   DELIVERY_ZONE_REQUIRED_FOR_COUNTRY: 'DELIVERY_ZONE_REQUIRED_FOR_COUNTRY' as const,
   DELIVERY_ADDRESS_REQUIRED: 'DELIVERY_ADDRESS_REQUIRED' as const,
   MERCHANDISE_NOT_APPLICABLE: 'MERCHANDISE_NOT_APPLICABLE' as const,
   MERCHANDISE_LINE_LIMIT_REACHED: 'MERCHANDISE_LINE_LIMIT_REACHED' as const,
   MERCHANDISE_NOT_ENOUGH_STOCK_AVAILABLE: 'MERCHANDISE_NOT_ENOUGH_STOCK_AVAILABLE' as const,
   MERCHANDISE_OUT_OF_STOCK: 'MERCHANDISE_OUT_OF_STOCK' as const,
   MERCHANDISE_PRODUCT_NOT_PUBLISHED: 'MERCHANDISE_PRODUCT_NOT_PUBLISHED' as const,
   PAYMENTS_ADDRESS1_INVALID: 'PAYMENTS_ADDRESS1_INVALID' as const,
   PAYMENTS_ADDRESS1_REQUIRED: 'PAYMENTS_ADDRESS1_REQUIRED' as const,
   PAYMENTS_ADDRESS1_TOO_LONG: 'PAYMENTS_ADDRESS1_TOO_LONG' as const,
   PAYMENTS_ADDRESS2_INVALID: 'PAYMENTS_ADDRESS2_INVALID' as const,
   PAYMENTS_ADDRESS2_REQUIRED: 'PAYMENTS_ADDRESS2_REQUIRED' as const,
   PAYMENTS_ADDRESS2_TOO_LONG: 'PAYMENTS_ADDRESS2_TOO_LONG' as const,
   PAYMENTS_CITY_INVALID: 'PAYMENTS_CITY_INVALID' as const,
   PAYMENTS_CITY_REQUIRED: 'PAYMENTS_CITY_REQUIRED' as const,
   PAYMENTS_CITY_TOO_LONG: 'PAYMENTS_CITY_TOO_LONG' as const,
   PAYMENTS_COMPANY_INVALID: 'PAYMENTS_COMPANY_INVALID' as const,
   PAYMENTS_COMPANY_REQUIRED: 'PAYMENTS_COMPANY_REQUIRED' as const,
   PAYMENTS_COMPANY_TOO_LONG: 'PAYMENTS_COMPANY_TOO_LONG' as const,
   PAYMENTS_COUNTRY_REQUIRED: 'PAYMENTS_COUNTRY_REQUIRED' as const,
   PAYMENTS_CREDIT_CARD_BASE_EXPIRED: 'PAYMENTS_CREDIT_CARD_BASE_EXPIRED' as const,
   PAYMENTS_CREDIT_CARD_BASE_GATEWAY_NOT_SUPPORTED: 'PAYMENTS_CREDIT_CARD_BASE_GATEWAY_NOT_SUPPORTED' as const,
   PAYMENTS_CREDIT_CARD_BASE_INVALID_START_DATE_OR_ISSUE_NUMBER_FOR_DEBIT: 'PAYMENTS_CREDIT_CARD_BASE_INVALID_START_DATE_OR_ISSUE_NUMBER_FOR_DEBIT' as const,
   PAYMENTS_CREDIT_CARD_BRAND_NOT_SUPPORTED: 'PAYMENTS_CREDIT_CARD_BRAND_NOT_SUPPORTED' as const,
   PAYMENTS_CREDIT_CARD_FIRST_NAME_BLANK: 'PAYMENTS_CREDIT_CARD_FIRST_NAME_BLANK' as const,
   PAYMENTS_CREDIT_CARD_GENERIC: 'PAYMENTS_CREDIT_CARD_GENERIC' as const,
   PAYMENTS_CREDIT_CARD_LAST_NAME_BLANK: 'PAYMENTS_CREDIT_CARD_LAST_NAME_BLANK' as const,
   PAYMENTS_CREDIT_CARD_MONTH_INCLUSION: 'PAYMENTS_CREDIT_CARD_MONTH_INCLUSION' as const,
   PAYMENTS_CREDIT_CARD_NAME_INVALID: 'PAYMENTS_CREDIT_CARD_NAME_INVALID' as const,
   PAYMENTS_CREDIT_CARD_NUMBER_INVALID: 'PAYMENTS_CREDIT_CARD_NUMBER_INVALID' as const,
   PAYMENTS_CREDIT_CARD_NUMBER_INVALID_FORMAT: 'PAYMENTS_CREDIT_CARD_NUMBER_INVALID_FORMAT' as const,
   PAYMENTS_CREDIT_CARD_SESSION_ID: 'PAYMENTS_CREDIT_CARD_SESSION_ID' as const,
   PAYMENTS_CREDIT_CARD_VERIFICATION_VALUE_BLANK: 'PAYMENTS_CREDIT_CARD_VERIFICATION_VALUE_BLANK' as const,
   PAYMENTS_CREDIT_CARD_VERIFICATION_VALUE_INVALID_FOR_CARD_TYPE: 'PAYMENTS_CREDIT_CARD_VERIFICATION_VALUE_INVALID_FOR_CARD_TYPE' as const,
   PAYMENTS_CREDIT_CARD_YEAR_EXPIRED: 'PAYMENTS_CREDIT_CARD_YEAR_EXPIRED' as const,
   PAYMENTS_CREDIT_CARD_YEAR_INVALID_EXPIRY_YEAR: 'PAYMENTS_CREDIT_CARD_YEAR_INVALID_EXPIRY_YEAR' as const,
   PAYMENTS_FIRST_NAME_INVALID: 'PAYMENTS_FIRST_NAME_INVALID' as const,
   PAYMENTS_FIRST_NAME_REQUIRED: 'PAYMENTS_FIRST_NAME_REQUIRED' as const,
   PAYMENTS_FIRST_NAME_TOO_LONG: 'PAYMENTS_FIRST_NAME_TOO_LONG' as const,
   PAYMENTS_INVALID_POSTAL_CODE_FOR_COUNTRY: 'PAYMENTS_INVALID_POSTAL_CODE_FOR_COUNTRY' as const,
   PAYMENTS_INVALID_POSTAL_CODE_FOR_ZONE: 'PAYMENTS_INVALID_POSTAL_CODE_FOR_ZONE' as const,
   PAYMENTS_LAST_NAME_INVALID: 'PAYMENTS_LAST_NAME_INVALID' as const,
   PAYMENTS_LAST_NAME_REQUIRED: 'PAYMENTS_LAST_NAME_REQUIRED' as const,
   PAYMENTS_LAST_NAME_TOO_LONG: 'PAYMENTS_LAST_NAME_TOO_LONG' as const,
   PAYMENTS_METHOD_UNAVAILABLE: 'PAYMENTS_METHOD_UNAVAILABLE' as const,
   PAYMENTS_METHOD_REQUIRED: 'PAYMENTS_METHOD_REQUIRED' as const,
   PAYMENTS_UNACCEPTABLE_PAYMENT_AMOUNT: 'PAYMENTS_UNACCEPTABLE_PAYMENT_AMOUNT' as const,
   PAYMENTS_PHONE_NUMBER_INVALID: 'PAYMENTS_PHONE_NUMBER_INVALID' as const,
   PAYMENTS_PHONE_NUMBER_REQUIRED: 'PAYMENTS_PHONE_NUMBER_REQUIRED' as const,
   PAYMENTS_POSTAL_CODE_INVALID: 'PAYMENTS_POSTAL_CODE_INVALID' as const,
   PAYMENTS_POSTAL_CODE_REQUIRED: 'PAYMENTS_POSTAL_CODE_REQUIRED' as const,
   PAYMENTS_SHOPIFY_PAYMENTS_REQUIRED: 'PAYMENTS_SHOPIFY_PAYMENTS_REQUIRED' as const,
   PAYMENTS_WALLET_CONTENT_MISSING: 'PAYMENTS_WALLET_CONTENT_MISSING' as const,
   PAYMENTS_BILLING_ADDRESS_ZONE_NOT_FOUND: 'PAYMENTS_BILLING_ADDRESS_ZONE_NOT_FOUND' as const,
   PAYMENTS_BILLING_ADDRESS_ZONE_REQUIRED_FOR_COUNTRY: 'PAYMENTS_BILLING_ADDRESS_ZONE_REQUIRED_FOR_COUNTRY' as const,
   TAXES_MUST_BE_DEFINED: 'TAXES_MUST_BE_DEFINED' as const,
   TAXES_LINE_ID_NOT_FOUND: 'TAXES_LINE_ID_NOT_FOUND' as const,
   TAXES_DELIVERY_GROUP_ID_NOT_FOUND: 'TAXES_DELIVERY_GROUP_ID_NOT_FOUND' as const
}
